      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="template-demo">
              <button type="button" class="btn btn-gradient-info btn-lg btn-block">Block buttons <i
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="template-demo">
                  ...
                  <button type="button" class="btn btn-gradient-dark btn-icon-text"> Edit <i
                ...
                <div class="template-demo">
                  ...
                  <button type="button" class="btn btn-gradient-info btn-icon-text"> Print <i
