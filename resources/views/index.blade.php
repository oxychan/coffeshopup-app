        ...
        <div class="container">
            <div class="row justify-content-start align-items-center">
                ...
                <div class="col-lg-6 video-left">
                    ...
                    <p>
                        A coffeehouse, coffee shop, or café is an establishment that primarily serves coffee of various
                        types, e.g. espresso,
                        latte, and cappuccino. Some coffeehouses may serve cold drinks, such as iced coffee, iced tea, and
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($menus as $menu)
                    <div class="col-lg-4 menu" id="menu" data-menuid="{{ $menu->id }}"
                        style="height: 230px !important">
                        <div class="single-menu">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{ asset($menu->menu_photo_path) }}" alt="menu" width="150px"
                                        height="150px">
                                </div>
                                <div class="col-md-6">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.modal-body').append(
                        '<div class="row">\
            										<div class="col-md-4">\
            											<img src="{{ asset('') }}' + data.menu.menu_photo_path + '" alt="Menu" width="200px">\
            										</div>\
            										<div class="col-md-8">\
