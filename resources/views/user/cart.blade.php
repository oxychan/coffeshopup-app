                        ...
                        <div class="md:grid md:grid-cols-12 gap-2 ">
                            <div class="col-span-12 p-5">
                                <button class="btn px-3"
                                    ...
                                    <a class="text-md font-medium mr-2 text-white" href="{{ route('user.menus') }}">Back
                                    </a>
                        ...
                        $('#items').append(
                            '<div class="flex justify-between items-center mb-3 pt-3 pb-3 border-b">\
                                <div class="flex ml-5 items-center">\
                                    <img src="{{ asset('') }}' + element.menu.menu_photo_path + '" width="100" class="rounded-full mr-5">\
                                ...
                                <div class="flex justify-center items-center mr-5">\
                                    <div class="pr-8 ">\
                                        <span class="text-lg font-medium">' + convertIDR(element.menu.price * element
                                .qty) + '</span>\
                                    </div>\
                                    <div>\
